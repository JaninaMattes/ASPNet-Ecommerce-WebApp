<%@ Page Language="C#" Title="Log In" MasterPageFile="/User Layer/Site.Master" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="WebsiteLaitBrasseur.Account.WebForm1" %>
...
<!--Page managing the login of an user to his account -->
            <div class="container-fluid " >
                    ...
                    <div class="col-md-offset-3 col-md-9">
                        ...
                        <a href='/User Layer/Account/Logout.aspx'>Forgot password ?</a><br />
