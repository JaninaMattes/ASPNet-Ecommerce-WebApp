            ...
            <div class="container-fluid">
                ...
                <div class="col-md-10">
                    <!-- GridView with seven fields and three buttons for edit the line / delete the line / show detail of the product  
                        Footer template isused to add a new product-->
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Price">
                                ...
                                <EditItemTemplate>
                                    ...
                                    <asp:RegularExpressionValidator ID="PriceEditRegValid" runat="server" ControlToValidate="TextEditPrice" ValidationExpression="([0-9]*\.)?[0-9]*" ErrorMessage="Please enter a valid number (decimal with dot)" ValidationGroup="Edit" CssClass="text-danger"></asp:RegularExpressionValidator><br />
                                ...
                                <FooterTemplate>
                                    ...
                                    <asp:RegularExpressionValidator ID="PriceRegValid" runat="server" ControlToValidate="TextAddPrice" ValidationExpression="([0-9]*\.)?[0-9]*" ErrorMessage="Please enter a valid number (decimal with dot)" ValidationGroup="add" CssClass="text-danger"></asp:RegularExpressionValidator><br />
                                </FooterTemplate>
                            </asp:TemplateField>
                    ...
                    <!--Button to Add a Product : make the footer visible-->
