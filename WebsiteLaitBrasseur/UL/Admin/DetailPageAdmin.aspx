        ...
        <ContentTemplate>
            ...
            <div class="container-fluid row">
                ...
                <div class="col-md-6">
                    ...
                    <!--Image informations  -->
                    <div class="col-md-6">
                        <asp:Image ID="DestinationImg" runat="server" AlternateText="Format issue" ImageUrl="~/Images/laitBrasseur.jpg" ToolTip="Product Image." Width="350px" Height="250px" /><br />
                        <br />
                ...
                <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <!--TextBox / label for Short Description -->
                        ...
                        <asp:RequiredFieldValidator ID="ShortReqField" runat="server" ControlToValidate="TextShortDescription" ErrorMessage="Short description is required" CssClass="text-danger"></asp:RequiredFieldValidator><br />
                        <br />
