            ...
            <div class="container-fluid ">
                ...
                <div class="col-md-12 row text-center">
                    ...
                    <div class="col-md-6">
                        ...
                        <!-- Gridview displaying cart products : quantity can be modified with a DropDownList-->
                    ...
                    <!--Right Side : Summary : Invoice costs and shippment options-->
                    <div class="col-md-5 offset-1 text-center">
                        <div id="CartTitle2" runat="server" class="ContentHead">
                            <h1>Summary</h1>
                            <br />
                        </div>
                        ...
                        <div style="font-size: 18px">
                            ...
                            <!--GRiedview displaying Postage options -->
