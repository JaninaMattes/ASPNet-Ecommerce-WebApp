...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <!--Page managing the modification of the Address -->
            ...
            <div class="container-fluid col-md-12 row">
                ...
                <div class="col-md-3">
                    ...
                    <!--Label /Double TextBox / Single Validator for the Address-->
                    <div class="form-group row">
                        <div class="col-md-4">
                ...
                <div class="col-md-4 text-center">
                    ...
                    <br />
                    <br />
                    <asp:Button ID="SaveAddress" runat="server" CssClass="btn btn-success" Text="Save address changes" OnClick="SaveButton_Click" /><br />
                    <br />
                    <br />
                    <br />
                    <asp:Button ID="Cart" runat="server" CssClass="btn btn-primary" OnClick="CartButton_Click" Text="Cart" /><br />
                    <br />
                    <br />
                    <br />
                </div>
